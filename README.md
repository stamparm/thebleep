...
And it is right more often, which matters more than being quick. The same 83
...
| the tool said so | **18/18** | 6/18 |
| nothing is right | **9/9** | 3/9 |
| **all of it** | **83/83 (100%)** | 55/83 (66%) |
<!-- end hit-rate -->

Only the *first* suggestion counts, because that is the one <kbd>enter</kbd>
runs. The last row is the one worth reading twice: a third of the time, given a
command where the honest answer is *no suggestion at all*, The Fuck offers
something anyway.
