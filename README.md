...
| the tool printed the answer | `git satus` | **18/18** | 6/18 |
| no suggestion is the right answer | `zzzzzqqqq` | **9/9** | 3/9 |
| **all 83 of them** |  | **83/83 (100%)** | 55/83 (66%) |
<!-- end hit-rate -->

Only the *first* suggestion counts, because that is the one <kbd>enter</kbd>
runs. The third row is the one worth reading twice: given a command where the
honest answer is *no suggestion at all*, The Fuck offers something anyway two
times in three.
